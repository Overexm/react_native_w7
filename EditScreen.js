...
const EditScreen = ()=>{
    ...
    <TouchableOpacity style={styles.pass} onPress={() => {}} >
      <Image source={require('../assets/icons/lock.png')} style={{width:13, height:10, marginRight:5, tintColor: '#7036B9',}}/>
      <Text style={{fontSize:12, color: '#3C1D62',}}>Change Password</Text>
      <Image source={require('../assets/icons/next.png')} style={{width:10, height:10, marginLeft:60, tintColor: '#7036B9',}}/>
    </TouchableOpacity>
      ...
      <TouchableOpacity style={{padding: 10}} onPress={() => {}}>
          <Text style={{color: 'red', fontWeight: '600', fontSize: 9,}}>DELETE PROFILE</Text>
      </TouchableOpacity>
